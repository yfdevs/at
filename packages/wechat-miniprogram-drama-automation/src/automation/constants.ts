...
export const playletUrl = "https://mp.weixin.qq.com/";
export const uploadPagePath = "/wxamp/webpocnew/playletUpload";
export const auditFormPagePath = "/wxamp/webpocnew/newAuditForm";
export const loginQrCodeSelector = [
  ".login__type__container__scan__qrcode",
  ".login__type__container img",
  "img.qrcode",
].join(", ");
export const rootSelector = "body";
export const auditFormSelector = "form.audit-form";
