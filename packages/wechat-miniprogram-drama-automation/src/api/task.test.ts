...
import { normalizeClaimedTaskConfig } from "../shared/config.js";
import { prepareWechatAiProductionProofMaterials } from "../shared/ai-production-proof-materials.js";
import {
...
test("creates a complete realistic WeChat Mini Program mock task", () => {
  ...
  assert.equal(config.playlet.episodeCount, 10);
  assert.match(
